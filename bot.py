...
class PharosBot:
        ...
        for op in operations:
            if op == "sign_in":
                ...
                for i in range(daily_transfers):
                    ...
                    await self.print_timer(random.randint(10, 15))
    ...
    async def process_accounts_concurrently(self, accounts, daily_transfers, daily_swaps, use_proxy, rotate_proxy, batch_size=5):
        """并发处理账户"""
